...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"LIST_PRODUCT_BLOCKS_ORDER" => "price,sku,props,quantityLimit,quantity,buttons",
...
<p data-block="2" class="catalog-page__text">
	 <?=$APPLICATION->ShowProperty("PAGE_DESCRIPTION")?>
</p>
 <a href="javascript:void(0);" data-btn="2" data-text="Скрыть текст" class="js-block-show link text">Читать далее</a><?require($_SERVER["DOCUMENT_ROOT"]."/bitrix/footer.php");?>