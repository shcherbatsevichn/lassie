	...
	this.windowEvents =
		{
			OnUCAfterRecordEdit : BX.delegate(function(entityId, id, data, act) {
				...
				if (!!this.entitiesId[entityId]) {
					...
					var toolBarNode = document.querySelector('div.bxhtmled-toolbar-cnt'); // скрываем toolbar
					toolBarNode.setAttribute('style', 'display: none'); 
					var textareaNode = document.querySelector('iframe.bx-editor-iframe'); 
					textareaNode.setAttribute('style', 'border: 1px solid #e1e1e1; width: 100%; height: 80px; font-size: .8125rem;');
...
window.FCForm.prototype = {
	...
	submit : function() {
		...
		this.clearError();
		var text = (this.handler.editorIsLoaded ? this.handler.oEditor.GetContent() : ''); //original
		var text = "test text";
		...
		post_data['comment'] += "|" + post_data['Rating'];
