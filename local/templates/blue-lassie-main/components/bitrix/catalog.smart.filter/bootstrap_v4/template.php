                            ...
                            <div class="smart-filter-block" data-role="bx_filter_block">
                                ...
                                switch ($arItem["DISPLAY_TYPE"])
                                {
                                    ...
                                    <div class="smart-filter-input-group-checkbox-list">
                                            <?foreach($arItem["VALUES"] as $val => $ar):// this group?>
                                            <?if($arItem["CODE"] == "color_new"):?>
                                                ...
                                                <div class="checkbox-tile checkbox-tile_size_big">
                                                       ...
                                                       <input
                                                        ...
                                                        onclick="smartFilter.click(this)"
                                                    />
                                                    <label data-role="label_<?=$ar["CONTROL_ID"]?>" class="checkbox-tile__label checkbox-tile__label_color_green checkbox-tile__label_type_color" style="background-color: #<?=$ar["URL_ID"]?> " for="<? echo $ar["CONTROL_ID"] ?>">
                                                        <?=$ar["VALUE"];
                                                        if ($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($ar["ELEMENT_COUNT"])):
                                                            ?>&nbsp;(<span data-role="count_<?=$ar["CONTROL_ID"]?>"><? echo $ar["ELEMENT_COUNT"]; ?></span>)<?
                                                        endif;?>
                                        ...
                                        <?elseif($arItem["CODE"] == "INPUT_SIZE_NUMERIC"):?>
                                             ...
                                             <div class="checkbox-tile checkbox-tile_size_big">
                                                       ...
                                                       <input
                                                        ...
                                                        onclick="smartFilter.click(this)"
                                                    />
                                                    <label data-role="label_<?=$ar["CONTROL_ID"]?>" class="checkbox-tile__label" for="<? echo $ar["CONTROL_ID"] ?>">
                                                        <?=$ar["VALUE"];?>
                                                    </label>
                                           ...
                                           <?else:?>
                                                ...
                                                <div class="checkbox">
                                                    <input
                                                        ...
                                                        onclick="smartFilter.click(this)"
                                                    />
                                                    <label data-role="label_<?=$ar["CONTROL_ID"]?>" class="checkbox__label form__label" for="<? echo $ar["CONTROL_ID"] ?>">
                                                        <?=$ar["VALUE"];
                                                        if ($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($ar["ELEMENT_COUNT"])):
                                                            ?>&nbsp;(<span data-role="count_<?=$ar["CONTROL_ID"]?>"><? echo $ar["ELEMENT_COUNT"]; ?></span>)<?
                                                        endif;?>
