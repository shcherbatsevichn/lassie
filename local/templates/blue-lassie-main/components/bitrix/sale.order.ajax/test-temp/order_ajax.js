	...
	BX.Sale.OrderAjaxComponent = {
		...
		sendRequest: function(action, actionData)
		{
			...
			if (action === 'saveOrderAjax')
			{
				...
				alert("bx-soa-order-form");
				alert("url: " + this.ajaxUrl);
				BX.ajax.submitAjax(
		...
		clickOrderSaveAction: function(event)
		{
			...
			{
				this.allowOrderSave();
				alert("clickOrderSaveAction");
				if (this.params.USER_CONSENT === 'Y' && BX.UserConsent)
				{
					alert("BX.onCustomEvent");
