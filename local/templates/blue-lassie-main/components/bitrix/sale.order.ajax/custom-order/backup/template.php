...
//dump($arResult["JS_DATA"]["PAY_SYSTEM"]);  //["ORDER_PROP"]["TOTAL"]      !!!!!!!!!!!!!!==========ПЕРЕПИСАТЬ РЕГИОНЫ ДЛЯ JS============!!!!!!!!!!!!!!!!!!!!!!!!!!
...
<form class="form js-form-validate order-page__form" action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM"  id="bx-soa-order-form" enctype="multipart/form-data" style="margin-top:15px;">
<?
		...
		<input type="hidden" name="BUYER_STORE" id="BUYER_STORE" value="<?=$arResult['BUYER_STORE']?>">
					...
					<div data-property-id-row="1">
						<div class="form__row" data-property-id-row="1">
							...
							<div class="form__col form__col_width_375">
								<input name="ORDER_PROP_1" id="soa-property-1" required class="input" type="text">
							</div>
						</div>
					</div>
					<div class="form__row" data-property-id-row="2">
							<div class="form__col form__col_width_220">
								<label for="order-mail" class="form__label">Электронная почта</label>
							</div>
							<div class="form__col form__col_width_260">
								<input name="ORDER_PROP_2" id="soa-property-2" autocomplete="email" type="email" required class="input">
							</div>
							<div class="form__col">
								<div class="form__info">Мы не рассылаем спам и не передаем информацию третьим лицам</div>
							</div>
					</div>
					<div class="form__row" data-property-id-row="3">
							<div class="form__col form__col_width_220">
								<label for="order-phone" class="form__label">Контактный телефон</label>
							</div>
							<div class="form__col form__col_width_260">
								<input name="ORDER_PROP_3" id="soa-property-3" autocomplete="tel" type="tel" required class="input">
					...
					<div data-property-id-row="1">
						<div class="form__row">
							<div class="form__col form__col_width_220">
								<label for="ORDER_PROP_7[city]" class="form__label">Город</label>
							</div>
							<div class="form__col form__col_width_260">
								<input name="ORDER_PROP_7[city]" id="soa-property-7-city" required class="input" type="text">
							</div>
						</div>
						<div class="form__row">
							<div class="form__col form__col_width_220">
								<label for="ORDER_PROP_7[street]" class="form__label">Улица</label>
							</div>
							<div class="form__col form__col_width_260">
								<input name="ORDER_PROP_7[street]" id="soa-property-7-street" required class="input" type="text">
							</div>
						</div>
						<div class="form__row">
							<div class="form__col form__col_width_220">
								<label for="ORDER_PROP_7[postcode]" class="form__label">Почтовый индекс</label>
							</div>
							<div class="form__col form__col_width_260">
								<input name="ORDER_PROP_7[postcode]" id="soa-property-7-postcode" required class="input" type="text">
							</div>
						</div>
						<div class="form__row">
							<div class="form__col form__col_width_220">
								<label for="ORDER_PROP_7[house]" class="form__label">Номер дома</label>
							</div>
							<div class="form__col form__col_width_90">
								<input name="ORDER_PROP_7[house]" id="soa-property-7-house" required class="input" type="text">
							</div>
						</div>
						<div class="form__row">
							<div class="form__col form__col_width_220">
								<label for="ORDER_PROP_7[housing]" class="form__label">Корпус</label>
							</div>
							<div class="form__col form__col_width_90">
								<input name="ORDER_PROP_7[housing]" id="soa-property-7-housing" class="input" type="text">
							</div>
						</div>
						<div class="form__row">
							<div class="form__col form__col_width_220">
								<label for="ORDER_PROP_7[apartment]" class="form__label">Номер квартиры</label>
							</div>
							<div class="form__col form__col_width_90">
								<input name="ORDER_PROP_7[apartment]" id="soa-property-7-apartment" class="input" type="text">
							</div>
						</div>
					</div>
					</fieldset>
				...
				<div id="bx-soa-orderSave">
					<div class="checkbox">
						...
						?>
						<a href="javascript:void(0)" style="margin: 10px 0" class="btn form__btn form__btn_align_right" data-save-button="true">
							<?=$arParams['MESS_ORDER']?>
						</a>
					</div>
				...
				<form  method="POST" name="" class="bx-soa-wrapper mb-4<?=$themeClass?>"  enctype="multipart/form-data">
		<?
		echo bitrix_sessid_post();
