				...
				<label for="raiting1-item1" class="raiting__star raiting__star_choose">1 звёзд</label>
												...
												<div class="form__row">
													...
													<div class="form__col form__col_width_260">
														<input id="user_name" name="user_name" tabindex="3" required class="input" type="text" value="<?=htmlspecialcharsEx($_SESSION["blog_user_name"])?>">
													</div>
												</div>
												<div class="form__row">
													<div class="form__col form__col_width_130">
													...
													<div class="form__col form__col_width_260">
														<input id="user_email" name="user_email" type="email" required class="input" tabindex="4" value="<?=htmlspecialcharsEx($_SESSION["blog_user_email"])?>">
													</div>
												</div>
												<div class="form__row">
													<div class="form__col form__col_width_130">
													...
													<div class="form__col form__col_width_400">
														<textarea id="review-message" name="Review[message]" required class="textarea"></textarea>
													</div>
												</div>
												<div class="form__row review-form__antispam-row">
													...
													<div class="form__col form__col_width_130">
														<input id="review-spam" name="Review[spam]" required class="input" type="text"><a href="javascript:void(0);" class="link review-form__refresh-captcha text">Обновить картинку</a>
													</div>
													<div class="form__col form__col_width_130">
				...
				<div class="blog-comment-fields">
					...
					if(empty($arResult["User"]))
					{
						...
						<div class="blog-comment-field blog-comment-field-user">
							<div class="form__row">
								<div class="form__col form__col_width_130">
									<label for="review-name" class="form__label"><?=GetMessage("B_B_MS_NAME")?></label>
								</div>
								<div class="form__col form__col_width_260">
									<input required class="input" type="text" name="user_name" id="user_name" value="<?=htmlspecialcharsEx($_SESSION["blog_user_name"])?>">
								</div>
							</div>
							...
							<div class="blog-comment-field blog-comment-field-email"><div class="blog-comment-field-text"><label for="">E-mail new email</label></div><span><input maxlength="255" size="30" tabindex="4" type="text" name="user_email" id="user_email" value="<?=htmlspecialcharsEx($_SESSION["blog_user_email"])?>"></span></div>
