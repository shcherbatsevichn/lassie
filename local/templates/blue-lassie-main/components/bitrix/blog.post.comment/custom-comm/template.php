											...
											<form method="post" action="" class="form js-form-validate">
												<div class="form__row">
													...
													<div class="form__col">
														...
														<?
														/**$GLOBALS['APPLICATION']->IncludeComponent(
															"bitrix:rating.vote", "standart_text",
															Array(
																"ENTITY_TYPE_ID" => "BLOG_COMMENT",
																"ENTITY_ID" => $comment["ID"],
																"OWNER_ID" => $comment["arUser"]["ID"],
												...
												<div class="form__row">
													...
													<div class="form__col form__col_width_260">
														<input id="user_email" name="user_email" tabindex="4" type="email" required class="input" value="<?=htmlspecialcharsEx($_SESSION["blog_user_email"])?>">
													</div>
												</div>
												<div class="form__row">
													<div class="form__col form__col_width_130">
