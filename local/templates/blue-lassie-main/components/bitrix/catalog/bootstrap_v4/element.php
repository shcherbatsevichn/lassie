...
?>
		...
		$componentElementParams = array(
			...
			'GIFTS_DETAIL_PAGE_ELEMENT_COUNT' => 5, //$arParams['GIFTS_DETAIL_PAGE_ELEMENT_COUNT'],
			...
			'GIFTS_MAIN_PRODUCT_DETAIL_PAGE_ELEMENT_COUNT' =>5, // $arParams['GIFTS_MAIN_PRODUCT_DETAIL_PAGE_ELEMENT_COUNT'],
			...
			if (!empty($recommendedData))
			{
				if (!empty($recommendedData['IBLOCK_LINK']) || !empty($recommendedData['ALL_LINK']))
				{
							...
							$APPLICATION->IncludeComponent('bitrix:catalog.recommended.products', 'bootstrap_v4', array(
									...
									'PRODUCT_PROPS_VARIABLE' => $arParams['PRODUCT_PROPS_VARIABLE'],
									'PARTIAL_PRODUCT_PROPERTIES' => (isset($arParams['PARTIAL_PRODUCT_PROPERTIES']) ? $arParams['PARTIAL_PRODUCT_PROPERTIES'] : ''),
									'PAGE_ELEMENT_COUNT' => 5,//$arParams['ALSO_BUY_ELEMENT_COUNT'],
									'LINE_ELEMENT_COUNT' => 5,//$arParams['ALSO_BUY_ELEMENT_COUNT'],
									'TEMPLATE_THEME' => (isset($arParams['TEMPLATE_THEME']) ? $arParams['TEMPLATE_THEME'] : ''),
									'SHOW_OLD_PRICE' => $arParams['SHOW_OLD_PRICE'],
									'SHOW_DISCOUNT_PERCENT' => $arParams['SHOW_DISCOUNT_PERCENT'],
				...
				if (!isset($arParams['DETAIL_SHOW_POPULAR']) || $arParams['DETAIL_SHOW_POPULAR'] != 'N')
				{
					...
					<article class="product-page__section">
						<h2 class="heading product-page__title"><span class="heading__text">Рекомендуем</span></h2>
							...
							<? $APPLICATION->IncludeComponent('bitrix:catalog.section', 'catalog-select-main-recomendation', array(
									'IBLOCK_TYPE' => $arParams['IBLOCK_TYPE'],
									'IBLOCK_ID' => $arParams['IBLOCK_ID'],
									'SECTION_ID' => $arResult['VARIABLES']['SECTION_ID'],
									'SECTION_CODE' => $arResult['VARIABLES']['SECTION_CODE'],
