! function a(b, c, d) {
    ...
    1: [function(a, b, c) {
        ...
        (function() {
            ...
            c = window.device, a = {}, window.device = a, e = window.document.documentElement, k = window.navigator.userAgent.toLowerCase(), a.ios = function() { return a.iphone() || a.ipod() || a.ipad() }, a.iphone = function() { return !a.windows() && f("iphone") }, a.ipod = function() { return f("ipod") }, a.ipad = function() { return f("ipad") }, a.android = function() { return !a.windows() && f("android") }, a.androidPhone = function() { return a.android() && f("mobile") }, a.androidTablet = function() { return a.android() && !f("mobile") }, a.blackberry = function() { return f("blackberry") || f("bb10") || f("rim") }, a.blackberryPhone = function() { return a.blackberry() && !f("tablet") }, a.blackberryTablet = function() { return a.blackberry() && f("tablet") }, a.windows = function() { return f("windows") }, a.windowsPhone = function() { return a.windows() && f("phone") }, a.windowsTablet = function() { return a.windows() && f("touch") && !a.windowsPhone() }, a.fxos = function() { return (f("(mobile;") || f("(tablet;")) && f("; rv:") }, a.fxosPhone = function() { return a.fxos() && f("mobile") }, a.fxosTablet = function() { return a.fxos() && f("tablet") }, a.meego = function() { return f("meego") }, a.cordova = function() { return window.cordova && "file:" === location.protocol }, a.nodeWebkit = function() { return "object" == typeof window.process }, a.mobile = function() { return a.androidPhone() || a.iphone() || a.ipod() || a.windowsPhone() || a.blackberryPhone() || a.fxosPhone() || a.meego() }, a.tablet = function() { return a.ipad() || a.androidTablet() || a.blackberryTablet() || a.windowsTablet() || a.fxosTablet() }, a.desktop = function() { return !a.tablet() && !a.mobile() }, a.television = function() {
                ...
                return !1
            }, a.portrait = function() { return window.innerHeight / window.innerWidth > 1 }, a.landscape = function() { return window.innerHeight / window.innerWidth < 1 }, a.noConflict = function() { return window.device = c, this }, f = function(a) { return -1 !== k.indexOf(a) }, h = function(a) { var b; return b = new RegExp(a, "i"), e.className.match(b) }, d = function(a) {
                var b = null;
                h(a) || (b = e.className.replace(/^\s+|\s+$/g, ""), e.className = b + " " + a)
            }, j = function(a) { h(a) && (e.className = e.className.replace(" " + a, "")) }, a.ios() ? a.ipad() ? d("ios ipad tablet") : a.iphone() ? d("ios iphone mobile") : a.ipod() && d("ios ipod mobile") : a.android() ? d(a.androidTablet() ? "android tablet" : "android mobile") : a.blackberry() ? d(a.blackberryTablet() ? "blackberry tablet" : "blackberry mobile") : a.windows() ? d(a.windowsTablet() ? "windows tablet" : a.windowsPhone() ? "windows mobile" : "desktop") : a.fxos() ? d(a.fxosTablet() ? "fxos tablet" : "fxos mobile") : a.meego() ? d("meego mobile") : a.nodeWebkit() ? d("node-webkit") : a.television() ? d("television") : a.desktop() && d("desktop"), a.cordova() && d("cordova"), g = function() { a.landscape() ? (j("portrait"), d("landscape")) : (j("landscape"), d("portrait")) }, i = Object.prototype.hasOwnProperty.call(window, "onorientationchange") ? "orientationchange" : "resize", window.addEventListener ? window.addEventListener(i, g, !1) : window.attachEvent ? window.attachEvent(i, g) : window[i] = g, g(), "function" == typeof define && "object" == typeof define.amd && define.amd ? define(function() { return a }) : "undefined" != typeof b && b.exports ? b.exports = a : window.device = a
        }).call(void 0)
    }, {}],
    2: [function(a, b, c) {
        (function(b) {
            ...
            b.jQuery = a("jquery"), a("jquery-validation"), e["default"](function() {
                jQuery.extend(jQuery.validator.messages, { required: "\u041f\u043e\u0436\u0430\u0439\u043b\u0443\u0439\u0441\u0442\u0430, \u0437\u0430\u043f\u043e\u043b\u043d\u0438\u0442\u0435 \u044d\u0442\u043e \u043f\u043e\u043b\u0435", email: "\u041f\u043e\u0436\u0430\u043b\u0443\u0439\u0441\u0442\u0430, \u0432\u0432\u0435\u0434\u0438\u0442\u0435 \u043a\u043e\u0440\u0440\u0435\u043a\u0442\u043d\u044b\u0439 \u0430\u0434\u0440\u0435\u0441 \u044d\u043b\u0435\u043a\u0442\u0440\u043e\u043d\u043d\u043e\u0439 \u043f\u043e\u0447\u0442\u044b" }), jQuery.validator.addMethod("tel", function(a, b) { return this.optional(b) || /^[\d\+][\d\(\)\ -]{3,18}\d$/.test(a) }, "\u041f\u043e\u0436\u0430\u043b\u0443\u0439\u0441\u0442\u0430, \u0432\u0432\u0435\u0434\u0438\u0442\u0435 \u043a\u043e\u0440\u0440\u0435\u043a\u0442\u043d\u044b\u0439 \u043d\u043e\u043c\u0435\u0440 \u0442\u0435\u043b\u0435\u0444\u043e\u043d\u0430"), e["default"](".js-form-validate").validate({
                    highlight: function(a, b, c) { e["default"](a).is('[type="checkbox"]') || e["default"](a).is('[type="radio"]') || (e["default"](a).addClass("invalid").removeClass("valid"), e["default"](a.form).find("label[for=" + a.id + "]").removeClass("form__label_valid").addClass("form__label_invalid")) },
                    unhighlight: function(a, b, c) { e["default"](a).is('[type="checkbox"]') || e["default"](a).is('[type="radio"]') || (e["default"](a).removeClass("invalid").addClass("valid"), e["default"](a.form).find("label[for=" + a.id + "]").addClass("form__label_valid").removeClass("form__label_invalid")) },
                    ignore: [],
                    ...
                    rules: { "Order[name]": { required: !0 }, "Order[mail]": { required: !0, email: !0 }, "Order[phone]": { required: !0, tel: !0 }, "Order[city]": { required: !0 }, "Order[street]": { required: !0 }, "Order[postcode]": { required: !0 }, "Order[house]": { required: !0 }, "Order[delivery]": { required: !0 }, "Order[payment]": { required: !0 }, "Rating": { required: !0 }, "user_name": { required: !0 }, "user_email": { required: !0, email: !0 }, "Review[message]": { required: !0 }, "captcha_word": { required: !0 } },
                    messages: { "Order[delivery]": { required: "\u041f\u043e\u0436\u0430\u043b\u0443\u0439\u0441\u0442\u0430, \u0432\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u0441\u043f\u043e\u0441\u043e\u0431 \u0434\u043e\u0441\u0442\u0430\u0432\u043a\u0438" }, "Order[payment]": { required: "\u041f\u043e\u0436\u0430\u043b\u0443\u0439\u0441\u0442\u0430, \u0432\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u0441\u043f\u043e\u0441\u043e\u0431 \u043e\u043f\u043b\u0430\u0442\u044b" }, "Review[raiting]": { required: "\u041f\u043e\u0436\u0430\u043b\u0443\u0439\u0441\u0442\u0430, \u043f\u043e\u0441\u0442\u0430\u0432\u044c\u0442\u0435 \u043e\u0446\u0435\u043d\u043a\u0443 \u0442\u043e\u0432\u0430\u0440\u0443" } }
                    ...
                    if (d.length && c.closest(".form__error-wrapper").hide(), f.length) {
                        ...
                        g.each(function() { e["default"](this).removeClass("form__label_valid form__label_invalid") }), h.each(function() { e["default"](this).hide() })
                    }
                })
            })
            ...
            b.jQuery = a("jquery"), a("../slider/jquery.bxslider"), e["default"](function() {
                e["default"](".gallery__thumbnails").each(function() {
                    ...
                    d.load(function() {
                        var c = a.outerWidth(),
                            d = 0;
                        b.each(function() { d += e["default"](this).outerWidth(!0) }), d > c && a.bxSlider({ pager: !1, touchEnabled: !0, slideWidth: 80, slideMargin: 20, maxSlides: 5 })
                    })
                    ...
                    if (d.length) {
                        var f = d.find(".gallery__thumbnails-img"),
                            ...
                            j = i.attr("src");
                        "mouseover" === a.type ? (i.attr("src", g), d.one("mouseout", function() { i.attr("src", j) })) : "click" === a.type && (c.hasClass("gallery__item_active") || (d.addClass("gallery__thumbnails-item_active").siblings().removeClass("gallery__thumbnails-item_active"), i.attr("src", g), d.off("mouseout")))
                    }
                })
            })
        }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
                ...
                var g = a(window).width(),
                    ...
                    u = function aa(a, b, c, d) {
                        if (e.usingCSS) {
                            ...
                            var h = {};
                            h[e.animProp] = a, "slide" == b ? f.animate(h, c, e.settings.easing, function() { G() }) : "reset" == b ? f.css(e.animProp, a) : "ticker" == b && f.animate(h, speed, "linear", function() { aa(d.resetValue, "reset", 0), L() })
                        }
                    },
                    v = function() {
                    ...
                    J = function() {
                        ...
                        e.settings.autoHover && f.hover(function() { e.interval && (f.stopAuto(!0), e.autoPaused = !0) }, function() { e.autoPaused && (f.startAuto(!0), e.autoPaused = null) })
                    },
                    K = function() {
                        var b = 0;
                        ...
                        u(b, "reset", 0), e.settings.pager = !1, e.settings.controls = !1, e.settings.autoControls = !1, e.settings.tickerHover && !e.usingCSS && e.viewport.hover(function() { f.stop() }, function() {
                            var b = 0;
                            e.children.each(function(c) { b += "horizontal" == e.settings.mode ? a(this).outerWidth(!0) : a(this).outerHeight(!0) });
    ...
    9: [function(a, b, c) {
        (function(b) {
            ...
            a("../blocks/input-number/input-number"), a("../blocks/gallery/gallery"), a("../blocks/tabs/tabs"), a("../blocks/navigation/navigation"), a("../blocks/popup/popup"), a("../blocks/form/form"), b.jQuery = a("jquery"), a("ion-rangeslider"), a("jquery.formstyler"), a("../blocks/devicejs/device"), e["default"](function() {
                ...
                }), e["default"](".slider__container").bxSlider({ auto: !0, autoHover: !0, touchEnabled: !0 }), e["default"](".range-slider__elem").ionRangeSlider({ type: "double", min: 0, max: 2e4, step: 100, hide_min_max: !0, hide_from_to: !0, onStart: function(b) { a(b) }, onChange: function(b) { a(b) } }), e["default"](".js-select").each(function() { e["default"](this).styler() }), e["default"](".header__menu").on("click", function(a) {
    ...
    }, { "../blocks/devicejs/device": 1, "../blocks/form/form": 2, "../blocks/gallery/gallery": 3, "../blocks/input-number/input-number": 4, "../blocks/navigation/navigation": 5, "../blocks/popup/popup": 6, "../blocks/tabs/tabs": 8, "ion-rangeslider": 10, jquery: 13, "jquery.formstyler": 12 }],
    10: [function(a, b, c) {
        ! function(a, b, c, d, e) {
            "use strict";
            var f = 0,
            ...
            l.prototype = {
                    ...
                    appendDisableMask: function() { this.$cache.cont.append(k), this.$cache.cont.addClass("irs-disabled") },
                    ...
                    calcPointerPercent: function() { return this.coords.w_rs ? (this.coords.x_pointer < 0 || isNaN(this.coords.x_pointer) ? this.coords.x_pointer = 0 : this.coords.x_pointer > this.coords.w_rs && (this.coords.x_pointer = this.coords.w_rs), void(this.coords.p_pointer = this.toFixed(this.coords.x_pointer / this.coords.w_rs * 100))) : void(this.coords.p_pointer = 0) },
                    convertToRealPercent: function(a) { var b = 100 - this.coords.p_handle; return a / b * 100 },
                    convertToFakePercent: function(a) { var b = 100 - this.coords.p_handle; return a / 100 * b },
                    getHandleX: function() {
                    ...
                    chooseHandle: function(a) { if ("single" === this.options.type) return "single"; var b = this.coords.p_from_real + (this.coords.p_to_real - this.coords.p_from_real) / 2; return a >= b ? this.options.to_fixed ? "from" : "to" : this.options.from_fixed ? "to" : "from" },
                    ...
                    callOnStart: function() { this.options.onStart && "function" == typeof this.options.onStart && this.options.onStart(this.result) },
                    callOnChange: function() { this.options.onChange && "function" == typeof this.options.onChange && this.options.onChange(this.result) },
                    callOnFinish: function() { this.options.onFinish && "function" == typeof this.options.onFinish && this.options.onFinish(this.result) },
                    callOnUpdate: function() { this.options.onUpdate && "function" == typeof this.options.onUpdate && this.options.onUpdate(this.result) },
                    ...
                    calcWithStep: function(a) { var b = Math.round(a / this.coords.p_step) * this.coords.p_step; return b > 100 && (b = 100), 100 === a && (b = 100), this.toFixed(b) },
                    checkMinInterval: function(a, b, c) { var e, f, d = this.options; return d.min_interval ? (e = this.convertToValue(a), f = this.convertToValue(b), "from" === c ? f - e < d.min_interval && (e = f - d.min_interval) : e - f < d.min_interval && (e = f + d.min_interval), this.convertToPercent(e)) : a },
                    checkMaxInterval: function(a, b, c) { var e, f, d = this.options; return d.max_interval ? (e = this.convertToValue(a), f = this.convertToValue(b), "from" === c ? f - e > d.max_interval && (e = f - d.max_interval) : e - f > d.max_interval && (e = f + d.max_interval), this.convertToPercent(e)) : a },
                    ...
                    toFixed: function(a) { return a = a.toFixed(9), +a },
                    ...
                    prettify: function(a) { var b = a.toString(); return b.replace(/(\d{1,3}(?=(?:\d\d\d)+(?!\d)))/g, "$1" + this.options.prettify_separator) },
                    checkEdges: function(a, b) { return this.options.force_edges ? (0 > a ? a = 0 : a > 100 - b && (a = 100 - b), this.toFixed(a)) : this.toFixed(a) },
                    validate: function() {
                    ...
                    calcGridCollision: function(a, b, c) { var d, e, f, g = this.coords.big_num; for (d = 0; g > d && (e = d + a / 2, !(e >= g)); d += a) f = this.$cache.grid_labels[e][0], c[d] <= b[e] ? f.style.visibility = "visible" : f.style.visibility = "hidden" },
                    calcGridMargin: function() { this.options.grid_margin && (this.coords.w_rs = this.$cache.rs.outerWidth(!1), this.coords.w_rs && ("single" === this.options.type ? this.coords.w_handle = this.$cache.s_single.outerWidth(!1) : this.coords.w_handle = this.$cache.s_from.outerWidth(!1), this.coords.p_handle = this.toFixed(this.coords.w_handle / this.coords.w_rs * 100), this.coords.grid_gap = this.toFixed(this.coords.p_handle / 2 - .1), this.$cache.grid[0].style.width = this.toFixed(100 - this.coords.p_handle) + "%", this.$cache.grid[0].style.left = this.coords.grid_gap + "%")) },
                    update: function(b) { this.input && (this.is_update = !0, this.options.from = this.result.from, this.options.to = this.result.to, this.options = a.extend(this.options, b), this.validate(), this.updateResult(b), this.toggleInput(), this.remove(), this.init(!0)) },
                ...
                }, a.fn.ionRangeSlider = function(b) { return this.each(function() { a.data(this, "ionRangeSlider") || a.data(this, "ionRangeSlider", new l(this, b, f++)) }) },
                function() {
                    ...
                    c.requestAnimationFrame || (c.requestAnimationFrame = function(b, d) {
                        var e = (new Date).getTime(),
                            f = Math.max(0, 16 - (e - a)),
                            g = c.setTimeout(function() { b(e + f) }, f);
                        return a = e + f, g
                    }), c.cancelAnimationFrame || (c.cancelAnimationFrame = function(a) { clearTimeout(a) })
                }()
        ...
        ! function(a) { "function" == typeof define && define.amd ? define(["jquery"], a) : a(jQuery) }(function(a) {
            a.extend(a.fn, {
                validate: function(b) {
                    ...
                    return c ? c : (this.attr("novalidate", "novalidate"), c = new a.validator(b, this[0]), a.data(this[0], "validator", c), c.settings.onclick && (this.on("click.validate", ":submit", function(b) { c.settings.submitHandler && (c.submitButton = b.target), a(this).hasClass("cancel") && (c.cancelSubmit = !0), void 0 !== a(this).attr("formnovalidate") && (c.cancelSubmit = !0) }), this.on("submit.validate", function(b) {
                ...
                rules: function(b, c) {
                    ...
                    if (b) switch (e = a.data(d.form, "validator").settings, f = e.rules, g = a.validator.staticRules(d), b) {
                        case "add":
                            ...
                            break;
                        case "remove":
                            return c ? (j = {}, a.each(c.split(/\s/), function(b, c) { j[c] = g[c], delete g[c], "required" === c && a(d).removeAttr("aria-required") }), j) : (delete f[d.name], g)
                    }
                ...
                prototype: {
                    ...
                    objectLength: function(a) { var c, b = 0; for (c in a) b++; return b },
                    ...
                    check: function(b) {
                        ...
                        var g, h, i, c = a(b).rules(),
                            d = a.map(c, function(a, b) { return b }).length,
                            e = !1,
                            f = this.elementValue(b);
                        for (h in c) { i = { method: h, parameters: c[h] }; try { if (g = a.validator.methods[h].call(this, f, b, i.parameters), "dependency-mismatch" === g && 1 === d) { e = !0; continue } if (e = !1, "pending" === g) return void(this.toHide = this.toHide.not(this.errorsFor(b))); if (!g) return this.formatAndAdd(b, i), !1 } catch (j) { throw this.settings.debug && window.console && console.log("Exception occurred when checking element " + b.id + ", check the '" + i.method + "' method.", j), j instanceof TypeError && (j.message += ".  Exception occurred when checking element " + b.id + ", check the '" + i.method + "' method."), j } }
                ...
                methods: {
                    ...
                    remote: function(b, c, d) {
                        ...
                        return this.settings.messages[c.name] || (this.settings.messages[c.name] = {}), e.originalMessage = this.settings.messages[c.name].remote, this.settings.messages[c.name].remote = e.message, d = "string" == typeof d && { url: d } || d, e.old === b ? e.valid : (e.old = b, f = this, this.startRequest(c), g = {}, g[c.name] = b, a.ajax(a.extend(!0, {
                            mode: "abort",
            ...
            var c, b = {};
            a.ajaxPrefilter ? a.ajaxPrefilter(function(a, c, d) { var e = a.port; "abort" === a.mode && (b[e] && b[e].abort(), b[e] = d) }) : (c = a.ajax, a.ajax = function(d) {
    ...
    12: [function(a, b, c) {
        ! function(d) { "function" == typeof define && define.amd ? define(["jquery"], d) : "object" == typeof c ? b.exports = d(a("jquery")) : d(jQuery) }(function(a) {
            ...
            function d(b, d) { this.element = b, this.options = a.extend({}, c, d), this.init() }
            ...
            var b = "styler",
                c = { wrapper: "form", idSuffix: "-styler", filePlaceholder: "\u0424\u0430\u0439\u043b \u043d\u0435 \u0432\u044b\u0431\u0440\u0430\u043d", fileBrowse: "\u041e\u0431\u0437\u043e\u0440...", fileNumber: "\u0412\u044b\u0431\u0440\u0430\u043d\u043e \u0444\u0430\u0439\u043b\u043e\u0432: %s", selectPlaceholder: "\u0412\u044b\u0431\u0435\u0440\u0438\u0442\u0435...", selectSearch: !1, selectSearchLimit: 10, selectSearchNotFound: "\u0421\u043e\u0432\u043f\u0430\u0434\u0435\u043d\u0438\u0439 \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d\u043e", selectSearchPlaceholder: "\u041f\u043e\u0438\u0441\u043a...", selectVisibleOptions: 0, singleSelectzIndex: "100", selectSmartPositioning: !0, onSelectOpened: function() {}, onSelectClosed: function() {}, onFormStyled: function() {} };
            d.prototype = {
                init: function() {
                    function g() {
                        var a = "",
                    ...
                    if (b.is(":checkbox")) {
                        ...
                        var j = function() {
                            ...
                            }).on("focus.styler", function() { h.addClass("focused") }).on("blur.styler", function() { h.removeClass("focused") }).on("click.styler", function() { h.removeClass("focused") })
                        };
                        j(), b.on("refresh", function() { b.off(".styler").parent().before(b).remove(), j() })
                        ...
                        var k = function() {
                            ...
                            c.is(".disabled") || (c.on("mousedown", "div.jq-number__spin", function() {
                                var b = a(this);
                                i(b), g = setTimeout(function() { h = setInterval(function() { i(b) }, 40) }, 350)
                            }).on("mouseup mouseout", "div.jq-number__spin", function() { clearTimeout(g), clearInterval(h) }), b.on("focus.styler", function() { c.addClass("focused") }).on("blur.styler", function() { c.removeClass("focused") }))
                        };
                        k(), b.on("refresh", function() { b.off(".styler").closest(".jq-number").before(b).remove(), k() })
                    } else if (b.is("select")) {
                        var l = function() {
                            function h(b) { b.off("mousewheel DOMMouseScroll").on("mousewheel DOMMouseScroll", function(b) { var c = null; "mousewheel" == b.type ? c = -1 * b.originalEvent.wheelDelta : "DOMMouseScroll" == b.type && (c = 40 * b.originalEvent.detail), c && (b.stopPropagation(), b.preventDefault(), a(this).scrollTop(c + a(this).scrollTop())) }) }
                            ...
                            function l() {
                                ...
                                var K = x.css("top");
                                if ("auto" == x.css("left") && x.css({ left: 0 }), "auto" == x.css("top") && x.css({ top: G }), x.hide(), J.length && (i.first().text() != w.text() && t.addClass("changed"), t.data("jqfs-class", J.data("jqfs-class")), t.addClass(J.data("jqfs-class"))), b.is(":disabled")) return t.addClass("disabled"), !1;
                                u.click(function() {
                                ...
                                }), z.hover(function() { a(this).siblings().removeClass("selected") });
                            ...
                            function m() {
                                ...
                                var e = a("ul", d).css({ position: "relative", "overflow-x": "hidden", "-webkit-overflow-scrolling": "touch" }),
                                    ...
                                    m = e.outerHeight(),
                                    n = f.outerHeight();
                                void 0 !== l && l > 0 ? e.css({ height: n * l }) : e.css({ height: 4 * n }), m > d.height() && (e.css("overflowY", "scroll"), h(e), f.filter(".selected").length && e.scrollTop(e.scrollTop() + f.filter(".selected").position().top)), b.prependTo(d).css({ position: "absolute", left: 0, top: 0, width: "100%", height: "100%", opacity: 0 }), b.is(":disabled") ? (d.addClass("disabled"), i.each(function() { a(this).is(":selected") && f.eq(a(this).index()).addClass("selected") })) : (f.filter(":not(.disabled):not(.optgroup)").click(function(c) {
                                    b.focus();
                                    var d = a(this);
                                    if (c.ctrlKey || c.metaKey || d.addClass("selected"), c.shiftKey || d.addClass("first"), c.ctrlKey || c.metaKey || c.shiftKey || d.siblings().removeClass("selected first"), (c.ctrlKey || c.metaKey) && (d.is(".selected") ? d.removeClass("selected first") : d.addClass("selected first"), d.siblings().removeClass("first")), c.shiftKey) {
                                        var e = !1,
                                            g = !1;
                                        d.siblings().removeClass("selected").siblings(".first").addClass("selected"), d.prevAll().each(function() { a(this).is(".first") && (e = !0) }), d.nextAll().each(function() { a(this).is(".first") && (g = !0) }), e && d.prevAll().each(function() { return a(this).is(".selected") ? !1 : void a(this).not(".disabled, .optgroup").addClass("selected") }), g && d.nextAll().each(function() { return a(this).is(".selected") ? !1 : void a(this).not(".disabled, .optgroup").addClass("selected") }), 1 == f.filter(".selected").length && d.addClass("first")
                                    }
                                ...
                                }), i.each(function(b) { a(this).data("optionIndex", b) }), b.on("change.styler", function() {
                                    f.removeClass("selected");
                                    var b = [];
                                    i.filter(":selected").each(function() { b.push(a(this).data("optionIndex")) }), f.not(".optgroup").filter(function(c) { return a.inArray(c, b) > -1 }).addClass("selected")
                                }).on("focus.styler", function() { d.addClass("focused") }).on("blur.styler", function() { d.removeClass("focused") }), m > d.height() && b.on("keydown.styler", function(a) {
                        ...
                        l(), b.on("refresh", function() { b.off(".styler").parent().before(b).remove(), l() })
                    } else b.is(":reset") && b.on("click", function() { setTimeout(function() { b.closest(c.wrapper).find("input, select").trigger("refresh") }, 1) })
                },
                destroy: function() {
                ...
                var e = arguments;
                if (void 0 === c || "object" == typeof c) return this.each(function() { a.data(this, "_" + b) || a.data(this, "_" + b, new d(this, c)) }).promise().done(function() {
                ...
                return qa.prototype = d.filters = d.pseudos, d.setFilters = new qa, g = ga.tokenize = function(a, b) {
                    ...
                    if (e = e || [], 1 === o.length) {
                        ...
                        for (i = X.needsContext.test(a) ? 0 : j.length; i-- && (k = j[i], !d.relative[l = k.type]);)
                            if ((m = d.find[l]) && (f = m(k.matches[0].replace(ca, da), aa.test(j[0].type) && pa(b.parentNode) || b))) { if (j.splice(i, 1), a = f.length && ra(j), !a) return H.apply(e, f), e; break }
                    }
